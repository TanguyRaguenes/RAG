...
class UsageRepository:
    ...
    async def ensure_active_quota_rule(
        self,
        *,
        user_id: str,
    ...
    async def get_active_quota_usage(self, user_id: str) -> tuple[int, int]:
        query = """
            ...
            GROUP BY active_quota.max_tokens_par_mois
        """
        ...
        return row["max_tokens_par_mois"], row["consumed_tokens"]
