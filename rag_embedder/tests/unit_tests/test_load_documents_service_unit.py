...
@pytest.mark.asyncio
async def test_load_documents_returns_markdown_reader_documents(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(load_documents_service, "read_markdown_documents", fake_read_markdown_documents)
